...
// ui
import { Header, Footer, Content, Cards } from 'qiao-ui';
...
const IndexPCView = () => {
  ...
  return (
    <div className="container">
      <Header logo={Constant.logo} logoUrl={Constant.logoUrl} navs={Constant.navs} />
      <Content contentName={Constant.contentName} contentSolgan={Constant.contentSolgan} />
      <Cards cards={DishiCards()} />
      <Footer
